...
export const readStoredView = (storageKey: string): View | null => {
...
export const writeStoredView = (storageKey: string, v: View) => {
...
export const getInitialView = (storageKey: string): View => {
